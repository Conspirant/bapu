  ...
  head: () => ({
    meta: [
      ...
      { title: "Bapu Speaks" },
      {
        name: "description",
        content:
          "An interactive school notice board: today's message, Gandhi's story and school notices.",
      },
      { property: "og:title", content: "Bapu Speaks" },
      {
      ...
      { name: "twitter:site", content: "@BapuSpeaks" },
    ],
    links: [
